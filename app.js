                     //Chapter No 21 to 25
             //Assignment Prepared By Muhammad Noman Ashraf
...
document.write("Welcome to Our page "+ fullname.toUpperCase());
// 2. Write a program to take a user input about his favorite
// mobile phone model. Find and display the length of user
// input in your browser
var mobile=prompt("Enter Your Favorite Mobiel Name")
var msg=mobile+" "+" is My Favourite Mobile"
document.write(msg+"<br>"+"Length of String is "+ msg.length);
...
document.write("String "+name+"<br>Last Index of l: "+name.lastIndexOf("l"))
// 5. Write a program to find the character at 3rd index in the
// word “Pakistani” and display the result in your browser.
var word=prompt("String");
var l = word[3];
...
var msg=prompt("city:");
var replaced_word = msg.replace("Hyderabad","Islamabad");
document.write("After replacement : "+replaced_word);
// 8. Write a program to replace all occurrences of “and” in the
// string with “&” and display the result in your browser.
// var message = “Ali and Sami are best friends. They play cricket and
// football together.”;
var msg = "Ali and Sami are best friends. They play cricket and football together."
replaced=msg.replace(/and/g,"&");
...
var msg=prompt("Enter your Letter ");
var capitalss=msg.toUpperCase();
document.write("Converted in Capital Letter:"+capitalss+"<br>");
// 11. Write a program that takes user input. Convert and
// show the input in title case.
var msg=prompt("User input ");
var titl=msg.charAt(0).toUpperCase() + msg.slice(1);
document.write("In Title :"+titl);
...
A = ["cake", "apple pie", "cookie", "chips", "patties"];
var itemin=prompt("Please Enter Your Choice");
...
// browser.
var n=0;
document.write("Random dice value is "+Math.floor((Math.random() * 6) + 1));
...
document.write("Your weight  is : "+weigh);
...
var dat = new Date();
var crnt = dat.getMonth();
mL = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
document.write("Current Month is :"+mL[crnt]+"<br>");
...
document.write("Welcome to this site "+fullName);
}
